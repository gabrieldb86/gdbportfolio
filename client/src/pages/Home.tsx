            ...
            <div className="hero-redesign-copy">
              <p className="eyebrow" style={{fontSize: '14px', width: '682px'}}>{siteConfig.hero.eyebrow}</p>
	              ...
	              <div className="hero-actions">
	                <a className="hero-cta" href="https://wa.me/5511945747353" target="_blank" rel="noreferrer" data-umami-event="hero-whatsapp-click" onClick={() => trackPortfolioEvent("cta_fale_comigo")} style={{fontSize: '23px', marginTop: '22px'}}>FALAR COM GABRIEL <ArrowUpRight size={15} style={{fontSize: '23px', marginTop: '-3px', height: '24px', marginLeft: '1px', width: '24px'}} /></a>
	              </div>
	            </div>
          </div>
