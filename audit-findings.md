...
## Rodada de alinhamento e imagens — inspeção de 2026-08-12

Após a primeira aplicação do eixo editorial comum, a heading da Área 02 passou a iniciar no mesmo eixo visual do hero. A inspeção do DOM/preview confirmou, porém, que somente os cards 01, 06 e 09 exibiam as capas específicas naquele momento; os cards 02–05, 07, 08 e 10 acionavam o fallback por indisponibilidade dos assets específicos. O editor já permite trocar cada imagem por upload ou URL, e a próxima correção reforça o fallback genérico persistente para que todos os dez cards mantenham uma imagem visível.

Na validação final, a Área 02 passou a usar cards verticais com imagem acima e legenda abaixo, mantendo 5 × 2 no desktop e uma coluna no mobile. Os assets disponíveis aparecem como fotografias; os demais cards exibem uma capa genérica visual com título e podem ser substituídos pelo editor. O eixo da heading e da grade coincide com o eixo editorial do hero. A Parte 03 agora removeu a imagem anterior e usa o bloco textual “Do briefing ao resultado.”; “resultado.” permanece em DM Serif Display, serif, itálico e carmim. CV, case Roadshow e editor foram recapturados em desktop e mobile sem overflow.
