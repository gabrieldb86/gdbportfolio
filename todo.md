...
## Correção estrutural da junção mobile — princípios e hero final
- [x] Remover overrides conflitantes de margem negativa, sombra e pseudo-elementos da transição
- [x] Fazer a seção bege crescer pelo conteúdo real e o hero vermelho iniciar no fluxo imediatamente seguinte
- [x] Reservar espaço suficiente para o cabeçalho fixo sem cortar os itens 02 e 03
- [x] Validar continuidade sem faixa preta em 375px e preservar desktop
- [x] Executar testes, build e checkpoint
